<?php
    ...
    class Persona {
        ...
        public function modificar() {
            $resp =false; 
            $base=new BaseDatos();
            $consultaModificar = "UPDATE persona SET apellido = '" . $this -> getApellido() . "', nombre = '" . $this -> getNombre() . "', email = '" . $this -> getEmail() . "' WHERE nrodoc = " . $this -> getNrodoc();
            if ($base -> Iniciar()) {
        ...
        public function eliminar() {
            ...
            $resp = false;
            if ($base -> Iniciar()) {
                $consultaBorrar = "DELETE FROM persona WHERE nrodoc = " . $this -> getNrodoc();
